...
class VolunteerContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        VolunteerContent::create([
            'hero_title' => 'انضم كمتطوع',
            'hero_title_en' => 'Join as Volunteer',

            'hero_desc' => 'كن جزءاً من فريقنا و ساهم في تحسين الخدمات الصحية وتقديم الدعم للمجتمعات المحتاجة. التطوع معنا فرصة للعطاء والنمو المهني والشخصي.',
