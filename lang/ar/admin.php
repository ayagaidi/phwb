...
return [
    ...
    'permissions' => [
        ...
        'description' => 'عرض وإدارة أقسام الصلاحيات والإجراءات المتاحة في النظام. استخدم هذه الصلاحيات لتحديد ما يمكن للمستخدمين الوصول إليه في لوحة التحكم.',
        ...
        'edit' => 'تعديل',
        'owner' => 'المالك',
        'none' => 'لا توجد صلاحيات',
        'admin_sections' => 'أقسام الإدارة',
        'staff_hint' => 'اختر الأقسام التي يستطيع هذا الموظف الوصول إليها في لوحة التحكم.',
        'select_sections' => 'اختر الأقسام',
        'multiselect_help' => 'اضغط Ctrl (أو Cmd) لاختيار أكثر من قسم.',
    ],
