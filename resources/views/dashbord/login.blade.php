...
<head>
  ...
  <meta name="description" content="صيادلة بلا حدود — تسجيل الدخول للوحة التحكم" />
  <title>صيادلة بلا حدود | تسجيل الدخول</title>
...
<body>
  ...
  <div class="login-page">
    ...
    <div style="position:relative; z-index:10; width:100%; max-width:420px; padding:0 1rem;">
      ...
      <p class="login-version">صيادلة بلا حدود - ليبيا</p>
    </div>
  </div>
