...
@section('content')
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('site.membership') }}" 
                       class="inline-flex items-center justify-center px-8 py-4 bg-white text-[#1e3a8a] font-semibold rounded-3xl hover:bg-gray-100 transition text-lg shadow-lg">
    ...
    <section class="max-w-6xl mx-auto px-6 mt-16">
        <div class="flex justify-between items-end mb-8">
            <div>
                <span class="text-sm font-medium text-[#1e3a8a]">{{ __('site.programs_label') }}</span>
                <h2 class="text-3xl font-bold tracking-tight">{{ __('site.programs_title') }}</h2>
            </div>
            <a href="{{ route('site.programs') }}" class="hidden md:flex items-center text-sm font-medium text-[#1e3a8a] hover:underline">
            ...
            @foreach($programs->take(3) as $program)
                <div class="modern-card bg-white rounded-3xl overflow-hidden border shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('site.programs') }}" class="text-sm font-medium text-[#1e3a8a] inline-flex items-center">
    ...
    <section class="max-w-5xl mx-auto px-6 mt-20">
        <div class="bg-gradient-to-l from-[#1e3a8a] to-[#1e40af] rounded-3xl p-10 md:p-14 text-white flex flex-col md:flex-row items-center gap-8">
            <div class="flex-1">
                <h2 class="text-3xl font-bold mb-4">{{ __('site.cta_title') }}</h2>
                <p class="text-blue-100 text-lg">{{ __('site.cta_subtitle') }}</p>
            </div>
            <div>
                <a href="{{ route('site.volunteer') }}" 
                   class="inline-block bg-white text-[#1e3a8a] font-bold px-9 py-4 rounded-3xl hover:bg-gray-100 transition shadow">
                    {{ __('site.cta_button') }}
                </a>
            </div>
        </div>
